...
def main():
    ...
    copied_image = copied_image[20:, 0:height]
    ...
    bottom_result = np.concatenate((bottom_part, manaul_threshold_bottom, bilateral_filter_bottom, thresholded_bottom, canny_bottom), axis=0)
